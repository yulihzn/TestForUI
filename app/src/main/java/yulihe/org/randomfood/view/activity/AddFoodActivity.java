...
public class AddFoodActivity extends BaseActivity implements TakePhoto.TakeResultListener,InvokeListener {
    private static final String TAG = AddFoodActivity.class.getName();
